        ...
        <div class="clearfix body-sec">
            <div class="clearfix sublist">
                <ul class="clearfix list-s">
                   <li><a href="admin_tender.jsp">Tender List</a></li>
                    <li class="active"><a href="admin_create_tender.jsp">Upload Tender</a></li>
                </ul>
            </div>
            <div class="content_sec" style="background: #fff;">
                <div class="clearfix downloadPosition"><a href="../admin_pages/sample_doc/POS-Sample-Tender-Format.xls" class="btn btn-primary">Download Sample Format</a></div>

                <form style="width:30%; margin: 0 auto;" action="tenderUploading" name="tenderUploading" method="post" enctype="multipart/form-data">
                    <div class="row-fluid">
