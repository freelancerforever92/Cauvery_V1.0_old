        ...
        <div class="clearfix body-sec">
            ...
            <div class="clearfix sublist">
                <ul class="clearfix list-s">
                    ...
                    <li class="active"><a href="admin_create_counter.jsp">Create Counter</a></li>
                ...
                <div class="clearfix create-counter">
                    ...
                    <div class="row-fluid">
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="span8">
                            <input type="text" name="branchCode" id="branchCode" class="input-block-level" readonly>
                        </div>
                    </div>                     
                    <div class="row-fluid" style="padding-top: 10px;">
                         ...
                         <div class="span4">
                             <input type="button" style="width: 100px;" class="btn btn-primary pull-right" value="Create" onclick="createCounter();">
                         </div>                  
                    </div>
                    </form>
                </div>
