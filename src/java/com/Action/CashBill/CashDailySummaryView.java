...
public class CashDailySummaryView extends ActionSupport {
    ...
    //<!--CHANGED CODE START with Craft group and Vendor parameter 08-01-2016 By Mastan-->
...
//    }
    ...
    public static List<CashLineItemDCSR> displayCashDailySummaryReportDCSR(String paraFromDate, String paraToDate, String paraPaymentType, String paraLoggedSessionId) {
        DaoClass daoClass = new DaoClass();
        List<CashHeaderDCSR> dCSRtos = new ArrayList();
        List<CashLineItemDCSR> summaryViewLinesDCSR = new ArrayList();
...
//            dCSRto.setCashLineItemDTO(summaryViewLinesDCSR);
    ...
    public static List<CashHeaderDCSR> userTotalDCSR(String paraFromDate, String paraToDate, String paraPaymentType, String paraLoggedSessionId) {
        ...
        try {
            ...
            //Logger.getLogger(CashDailySummaryView.class.getName()).log(Level.SEVERE, null, ex);
