...
(function($) {
    ...
    var barcode = {
        ...
        digitToCssRenderer: function($container, settings, digit, hri, mw, mh) {
            ...
            if (settings.showHRI) {
                //Manually Changed
                content += "<div style=\"clear:both; width: 100%;display: none; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: " + settings.fontSize + "px; margin-top: " + settings.marginHRI + "px;\">" + "" + "</div>";
            }
        ...
        digitToSvgRenderer: function($container, settings, digit, hri, mw, mh) {
            ...
            if (settings.showHRI) {
                ...
                //Manually Changed
                svg += '<text y="' + (height - Math.floor(fontSize / 2)) + '" text-anchor="middle" style="font-family: Arial;display: none; font-size: ' + fontSize + 'px;" fill="' + settings.color + '">' + "" + '</text>';
                svg += '</g>';
            }
            // svg footer
            svg += '</svg>';
